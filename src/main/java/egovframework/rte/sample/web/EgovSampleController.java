...
import egovframework.rte.cmmn.security.EgovUserDetailsVO;
import egovframework.rte.fdl.property.EgovPropertyService;
import egovframework.rte.improved.security.userdetails.util.EgovUserDetailsHelper;
...
public class EgovSampleController {
    ...
    public String selectSampleList(@ModelAttribute("searchVO") SampleDefaultVO searchVO, 
        ...
        if (EgovUserDetailsHelper.getAuthenticatedUser() instanceof EgovUserDetailsVO) {
	        EgovUserDetailsVO user = (EgovUserDetailsVO)EgovUserDetailsHelper.getAuthenticatedUser();
	        
	        if (user != null) {
	        	System.out.println("Logined user : " + user.getUserName());
	        }
        } else {
        	System.out.println("Current user : " + EgovUserDetailsHelper.getAuthenticatedUser());
        }
